...
public class MatchService {
    ...
    public MatchResult computeMatch(Long studentAId, Long studentBId) {
        ...
        MatchResult result =
                new MatchResult(studentA, studentB, score, reasonSummary);
    ...
    private double calculateCompatibilityScore(
        ...
        if (habitA.getCleanlinessLevel() != null &&
                habitB.getCleanlinessLevel() != null) {
            score -= Math.abs(
    ...
    private double calculateTimeDifferencePenalty(
            LocalTime time1,
            LocalTime time2) {
